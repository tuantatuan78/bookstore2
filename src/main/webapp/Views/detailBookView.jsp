...
<head>
    ...
    <script>
        ...
        function prepareToAddToCart(bookId, maxQuantity) {
            let quantity = parseInt(document.getElementById('quantity' + bookId).value);
            ...
            <div class="container">
                <form id="detailBookForm" action="cartBook/addToCart" method="POST">
                    ...
                    <div style="margin-top: 20px;">
                        ...
                        <input type="text" value="1" size="2" style="line-height: 20px" onchange="validateValue(this,${book.quantityInStock})" id="quantity${book.bookId}" name="quantityPurchased" />
                        <img src="img/icon-add.png" onclick="plusValue('quantity${book.bookId}',${book.quantityInStock})" width="20px" height="20px" />
                        <c:if test="${not empty loginedUser }">
                            <button type="button" onclick="prepareToAddToCart('${book.bookId}', ${book.quantityInStock})">Thêm vào giỏ hàng</button>
                        </c:if>
                    ...
                    <input type="hidden" name="quantityPurchased" id="quantityPurchased" value="" />
                </form>
            </div>
        </c:if>
    </div>
